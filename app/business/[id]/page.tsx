    ...
    <>
      ...
      <main className="biz-page">
        ...
        <div className="biz-content">
          <div className="biz-main">
            ...
            <div className="cta-buttons">
              ...
              {biz.whatsapp && (
                <a href={`https://wa.me/${biz.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="cta-btn whatsapp">
          ...
          <div className="biz-sidebar">
            <div className="sidebar-card">
              ...
              {biz.whatsapp && (
                <a href={`https://wa.me/${biz.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="sidebar-cta whatsapp">
                  💬 Chat on WhatsApp
                </a>
              )}
              {biz.email && (
        ...
        <div className="mobile-sticky">
          ...
          {biz.whatsapp && (
            <a href={`https://wa.me/${biz.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="sticky-whatsapp">💬 WhatsApp</a>
          )}
        </div>
