  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: "'Sora', sans-serif", color: 'var(--white)' }}>
      <style>{`
        ...
        .re-hero h1{font-size:clamp(32px,6vw,58px);font-weight:800;line-height:1.08;letter-spacing:-0.03em;margin-bottom:18px;color:var(--white);}
        .re-hero h1 span{color:var(--red);}
        .re-hero p{font-size:clamp(15px,2vw,18px);color:var(--muted);max-width:520px;margin:0 auto 40px;line-height:1.65;font-weight:300;}
        ...
        .re-cat-label{font-size:12px;font-weight:600;color:var(--off);}
        .re-section{position:relative;z-index:1;max-width:1100px;margin:0 auto;padding:0 24px 80px;}
        .re-section-title{font-size:22px;font-weight:700;color:var(--white);margin-bottom:6px;}
        ...
        .re-card-title{font-size:15px;font-weight:600;color:var(--white);margin-bottom:5px;line-height:1.4;}
        ...
        .re-empty-title{font-size:20px;font-weight:600;color:var(--off);margin-bottom:8px;}
